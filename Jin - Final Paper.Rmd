...
This project investigates factors influencing carbon dioxide (CO2) emissions from vehicles, focusing on models released between 2020 and 2024. Using fuel economy data from U.S. Department of Energy, we analyze the relationships between vehicle attributes and the amount of CO2 emitted from a vehicle's tailpipe. The study addresses three objectives: constructing a linear regression model to quantify the impact of vehicle features on CO2 emissions, clustering vehicles based on their attributes to identify distinct groups and their defining characteristics, and implementing a classification tree to predict vehicle sustainability based on emissions. Our goal is to offer insights into the variables that have critical impact in CO2 emissions of modern vehicles, provide perspectives that could support environmental policies.
